...
HD_PWD='C:/Users/Kushal Agrawal/UW-madison school work/Dual-FPGA-Trading-Engine/vivado/hft_board_b/hft_board_b.runs/system_zynq_ps_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_zynq_ps_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_zynq_ps_0.tcl
