...
HD_PWD='C:/Users/Kushal Agrawal/UW-madison school work/Dual-FPGA-Trading-Engine/vivado/hft_board_a/hft_board_a.runs/system_hft_core_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_hft_core_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_hft_core_0.tcl
