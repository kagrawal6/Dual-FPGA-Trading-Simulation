...
HD_PWD='C:/Users/Kushal Agrawal/UW-madison school work/Dual-FPGA-Trading-Engine/vivado/hft_board_b/hft_board_b.runs/system_rst_sys_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_sys_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_sys_0.tcl
